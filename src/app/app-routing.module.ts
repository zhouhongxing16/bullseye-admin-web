...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'organization',
        loadChildren: () => import( '././modules/system/organization/organization.module').then(m => m.OrganizationModule)
      },
      ...
      {
        path: 'dictionarydata',
        loadChildren: () => import('././modules/system/dictionary-data/dictionary-data.module').then(m => m.DictionaryDataModule)
      },
